...
import org.embulk.output.GcsTransactionalFileOutput;
...
public final class GCSMediaHttpUploader
{
    /**
     ...
     */
    private GCSMediaHttpUploaderProgressListener progressListener;
     ...
     */
    private long totalBytesClientSent = 0L;
     ...
     * {@code null} for none
     */
    public GCSMediaHttpUploader(AbstractInputStreamContent mediaContent, HttpTransport transport,
     ...
     *
     * <p>
     * This method is not reentrant. A new instance of {@link GCSMediaHttpUploader} must be instantiated
            ...
            throws IOException
    {
        ...
        if (uploadState == UploadState.NOT_STARTED || getUploadUrl() == null) {
        ...
        else if (totalBytesClientSent > totalBytesServerReceived) {
            // reset to the last sent file
        ...
        while (true) {
            ...
            totalBytesClientSent = totalBytesClientSent + chunkSize;
...
//        request.setContent(content);
     ...
     */
    public GCSMediaHttpUploader setMetadata(HttpContent metadata)
    {
     ...
     * @since 1.9
     */
    public GCSMediaHttpUploader setDirectUploadEnabled(boolean directUploadEnabled)
    {
     ...
     */
    public GCSMediaHttpUploader setProgressListener(GCSMediaHttpUploaderProgressListener progressListener)
    {
     ...
     * </p>
     */
    public GCSMediaHttpUploader setChunkSize(int chunkSize)
    {
     ...
     * @since 1.13
     */
    public GCSMediaHttpUploader setDisableGZipContent(boolean disableGZipContent)
    {
     ...
     * @since 1.15
     */
    public GCSMediaHttpUploader setSleeper(Sleeper sleeper)
    {
     ...
     * @since 1.12
     */
    public GCSMediaHttpUploader setInitiationRequestMethod(String initiationRequestMethod)
    {
     ...
     */
    public GCSMediaHttpUploader setInitiationHeaders(HttpHeaders initiationHeaders)
    {
    ...
    public GenericUrl getUploadUrl()
    {
        return uploadUrl;
    }
}
